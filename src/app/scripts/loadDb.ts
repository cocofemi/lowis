...
const supportedAccomodation= [
    ...
    'https://assets.publishing.service.gov.uk/media/6514400088281e000db4e965/Guide_to_the_supported_accommodation_regulations_including_quality_standards.pdf'
]
